...
Find part1 and two in the same zip file in one project under the packages "withoutpageobject" and "withpageobject"
Part 3 zip file contains both the react project and the java selenium project(find code under package "assignment")
same for part 4
part 5 contais the java selenium test under the "assignment" package as well

--The Main Pages in the projects are just samples generated by the Selenium addin
